    ...
    \block{Clustering choice} {%
        \begin{minipage}{0.22\textwidth}
            \coloredbox{
                ...
                2D demonstation of \polychord{} K-Nearest Neighbours, \texttt{pyclustering} X-means and \texttt{scikit-learn} DBSCAN \cite{polychorda, polychordb, pyclustering, sklearn}.
            }
        \end{minipage}
        \hfill
        \begin{minipage}{0.22\textwidth}
