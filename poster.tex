...
\begin{columns}
    ...
    \block{The first text box}{%
        ...
        \includegraphics[height=0.13\textwidth]{images/amsterdam/convex}
    ...
    \block{Application to cosmological $\mathcal P_\mathcal R(k)$}{%
        ...
        \begin{minipage}[]{0.2\textwidth}
            \centering
            \includegraphics[width=\textwidth]{images/image_9}
        \end{minipage}\hfill
        \begin{minipage}[]{0.2\textwidth}
            ...
            Functional posteriors were produced using the \texttt{fgivenx} package \cite{fgivenx}
        ...
        \begin{minipage}[]{0.22\textwidth}
            \centering
            \includegraphics[width=\textwidth]{images/image_7}
            \includegraphics[width=\textwidth]{images/image_8}
        \end{minipage}%
        \begin{minipage}[]{0.14\textwidth}
            \centering
            \includegraphics[width=\textwidth]{images/image_2}
        \end{minipage}
