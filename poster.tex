...
\begin{columns}
    ...
    \block{Cosmological application $\mathcal P_\mathcal R(k)$}{%
        ...
        \end{minipage}\\
        \coloredbox{K-nearest-neighbours and DBSCAN fail to separate the central knot into two clusters, while X-means does so reliably. The likelihood information approach was able to separate the central knot into multiple clusters, but also tended to over-cluster.}
    }
