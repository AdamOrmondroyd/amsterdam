    ...
    \block{The first text box}{%
        ...
        \begin{minipage}{0.22\textwidth}
            \coloredbox{
                ...
                2D demonstation of \polychord{} K-Nearest Neighbours, \texttt{pyclustering} X-means and \texttt{scikit-learn} DBSCAN and HDBSCAN \cite{polychorda, polychordb, pyclustering, sklearn}.
            }
        \end{minipage}\\
   }
