...
\begin{columns}
    ...
    \block{Cosmological applications $\mathcal P_\mathcal R(k)$}{%
        ...
        \end{minipage}
        \coloredbox{Gah it's just escaped me.}
    }
